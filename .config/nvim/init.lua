...
-- this Telescope section conflicts with keybinds in plugins.telescope
-- [[ Configure Telescope ]]
...
-- removed due to telescope pathogen
...
vim.defer_fn(function()
  vim.treesitter.language.register('clojure', { 'hy' })
